...
1. 创建流程 	
   ...
   <font color=red>注意：</font>如果在创建项目时没有选择云开发，则文件夹中不会显示 cloudfunctions 文件夹，在开发过程中若突然想使用，可以在创建该文件夹，并在全局的 project.config.json 文件中添加 "cloudfunctionRoot":"cloudfunctions/"(创建的名字)
